...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-2226-seymour-s-r-graph-conjecture-ed4a2dac-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-2226"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-2226-seymour-s-r-graph-conjecture-ed4a2dac-v1",
      "problem_contract_sha256": "7a85b7ab57a8570c950a553244113e2900393f440a9277c4f2e19fdadb63be67",
      "problem_id": "problem:um-opg-2226-seymour-s-r-graph-conjecture-ed4a2dac",
      "route_id": "route:um-opg-2226-seymour-s-r-graph-conjecture-ed4a2dac-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-2226-seymour-s-r-graph-conjecture-ed4a2dac-source-fidelity-01",
      "graph_id": "graph:um-opg-2226-seymour-s-r-graph-conjecture-ed4a2dac-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-2226-seymour-s-r-graph-conjecture-ed4a2dac-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-2226-seymour-s-r-graph-conjecture-ed4a2dac-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "An $r$-graph is an $r$-regular graph $G$ with the property that $|\\delta(X)| \\ge r$ for every $X \\subseteq V(G)$ with odd size. Conjecture $\\chi'(G) \\le r+1$ for every $r$-graph $G$."
          },
          "statement_sha256": "8f155940baab530521b34a4f0f1d82bc748ebc776c0a45104ff4e78a7e93b34f"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-2226-seymour-s-r-graph-conjecture-ed4a2dac-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-2226-seymour-s-r-graph-conjecture-ed4a2dac-root",
      "route_id": "route:um-opg-2226-seymour-s-r-graph-conjecture-ed4a2dac-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-2226-261855d3f1c7",
        "url": "https://www.unsolvedmath.com/problems/OPG-2226"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
